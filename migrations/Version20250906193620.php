 ...
 */
final class Version20250906193620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE symfony_demo_access_token ADD user_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE symfony_demo_comment ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
        ...
        $this->addSql('ALTER INDEX idx_24595_idx_53ad8f834b89032c RENAME TO IDX_53AD8F834B89032C');
        $this->addSql('ALTER INDEX idx_24595_idx_53ad8f83f675f31b RENAME TO IDX_53AD8F83F675F31B');
        ...
        $this->addSql('ALTER TABLE symfony_demo_post ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
        ...
        $this->addSql('ALTER INDEX idx_24578_idx_58a92e65f675f31b RENAME TO IDX_58A92E65F675F31B');
        ...
        $this->addSql('ALTER INDEX idx_24584_idx_6abc1cc44b89032c RENAME TO IDX_6ABC1CC44B89032C');
        $this->addSql('ALTER INDEX idx_24584_idx_6abc1cc4bad26311 RENAME TO IDX_6ABC1CC4BAD26311');
        $this->addSql('ALTER TABLE symfony_demo_tag ALTER id TYPE INT');
        $this->addSql('ALTER TABLE symfony_demo_tag ALTER id DROP DEFAULT');
        $this->addSql('ALTER TABLE symfony_demo_tag ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
        ...
        $this->addSql('ALTER INDEX idx_24588_uniq_4d5855405e237e06 RENAME TO UNIQ_4D5855405E237E06');
        ...
        $this->addSql('ALTER TABLE symfony_demo_user ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
        ...
        $this->addSql('ALTER TABLE symfony_demo_user ALTER roles TYPE JSON USING roles::json');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER roles SET NOT NULL');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER modified_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER INDEX idx_24607_uniq_8fb094a1f85e0677 RENAME TO UNIQ_8FB094A1F85E0677');
        $this->addSql('ALTER INDEX idx_24607_uniq_8fb094a1e7927c74 RENAME TO UNIQ_8FB094A1E7927C74');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP INDEX UNIQ_CEFBA3145F37A13B');
        $this->addSql('ALTER TABLE symfony_demo_access_token DROP user_id');
        $this->addSql('ALTER TABLE symfony_demo_comment ALTER id TYPE BIGINT');
        $this->addSql('ALTER TABLE symfony_demo_comment ALTER id SET DEFAULT nextval(\'symfony_demo_comment_id_seq\'::regclass)');
        $this->addSql('ALTER TABLE symfony_demo_comment ALTER id DROP IDENTITY');
        ...
        $this->addSql('ALTER INDEX idx_53ad8f83f675f31b RENAME TO idx_24595_idx_53ad8f83f675f31b');
        $this->addSql('ALTER INDEX idx_53ad8f834b89032c RENAME TO idx_24595_idx_53ad8f834b89032c');
        $this->addSql('ALTER TABLE symfony_demo_post ALTER id TYPE BIGINT');
        $this->addSql('ALTER TABLE symfony_demo_post ALTER id SET DEFAULT nextval(\'symfony_demo_post_id_seq\'::regclass)');
        $this->addSql('ALTER TABLE symfony_demo_post ALTER id DROP IDENTITY');
        ...
        $this->addSql('ALTER INDEX idx_58a92e65f675f31b RENAME TO idx_24578_idx_58a92e65f675f31b');
        ...
        $this->addSql('ALTER INDEX idx_6abc1cc4bad26311 RENAME TO idx_24584_idx_6abc1cc4bad26311');
        $this->addSql('ALTER INDEX idx_6abc1cc44b89032c RENAME TO idx_24584_idx_6abc1cc44b89032c');
        $this->addSql('ALTER TABLE symfony_demo_tag ALTER id TYPE BIGINT');
        $this->addSql('ALTER TABLE symfony_demo_tag ALTER id SET DEFAULT nextval(\'symfony_demo_tag_id_seq\'::regclass)');
        $this->addSql('ALTER TABLE symfony_demo_tag ALTER id DROP IDENTITY');
        ...
        $this->addSql('ALTER INDEX uniq_4d5855405e237e06 RENAME TO idx_24588_uniq_4d5855405e237e06');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER id TYPE BIGINT');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER id SET DEFAULT nextval(\'symfony_demo_user_id_seq\'::regclass)');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER id DROP IDENTITY');
        ...
        $this->addSql('ALTER TABLE symfony_demo_user ALTER created_at TYPE TIMESTAMP(0) WITH TIME ZONE');
        $this->addSql('ALTER TABLE symfony_demo_user ALTER modified_at TYPE TIMESTAMP(0) WITH TIME ZONE');
        ...
        $this->addSql('ALTER INDEX uniq_8fb094a1f85e0677 RENAME TO idx_24607_uniq_8fb094a1f85e0677');
        $this->addSql('ALTER INDEX uniq_8fb094a1e7927c74 RENAME TO idx_24607_uniq_8fb094a1e7927c74');
    }
}
