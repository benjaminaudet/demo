 ...
 */
final class Version20250901101412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE symfony_demo_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles CLOB NOT NULL, created_at DATETIME DEFAULT NULL, modified_at DATETIME DEFAULT NULL)');
        ...
        $this->addSql('UPDATE symfony_demo_user SET created_at = CURRENT_TIMESTAMP WHERE created_at IS NULL');
        $this->addSql('UPDATE symfony_demo_user SET modified_at = CURRENT_TIMESTAMP WHERE modified_at IS NULL');
